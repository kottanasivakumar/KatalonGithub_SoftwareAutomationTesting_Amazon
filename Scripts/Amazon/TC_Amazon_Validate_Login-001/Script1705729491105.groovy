...
WebUI.setText(findTestObject('Object Repository/Amazon_Login_OR/Page_Amazon Sign-In/input_email'), 'sivakumarkottana2000@gmail.com')

WebUI.click(findTestObject('Object Repository/Amazon_Login_OR/Page_Amazon Sign-In/inputcontinue'))

WebUI.setEncryptedText(findTestObject('Object Repository/Amazon_Login_OR/Page_Amazon Sign-In/input_password'), 'DTj8m5Ry/xZVxpyMM/dUZQ==')
